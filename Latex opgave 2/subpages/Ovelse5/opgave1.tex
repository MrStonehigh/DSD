...
\begin{enumerate}
	...
	Vi skriver behavioral style koden som vist i figur \ref{lst:processState}
		...
		\newpage
		\item[2)]
		Illustreret herunder er sandhedstabellen for figur \ref{fig:RTL process}.
		\begin{figure}[h]
			\centering
	...
	\item[3)]
	Vi skriver koden for truth-tabellen sådan at x og y bliver initialiseret i hver deres proces, som det ses i kode \ref{lst:truthtab} 
