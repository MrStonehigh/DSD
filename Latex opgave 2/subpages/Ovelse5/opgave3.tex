...
when others => seg10 <= "1111111"; -- Slukket
	...
	\end{figure}
		...
		--gg: entity work.guessgame port map (input => input, set => set, show => show, try => try, seg1 => seg1, seg10 => seg10);
